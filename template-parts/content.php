...
if( is_single() ): ?>
        <div id="post-<?php the_ID(); ?>" <?php post_class('blog-wrapper mb-30'); ?> data-wow-delay=".3s">
			...
			<?php endif; ?>
            <div class="blog-text blog-details-content">
                <div class="blog-meta">
                    <span>
...
<?php
    ...
    <div id="post-<?php the_ID(); ?>" <?php post_class('blog-wrapper mb-40'); ?> data-wow-delay=".3s">
        ...
        <div class="blog-text">
            ...
            <!-- blog btn -->
            <?php 
                $hobi_blog_btn     = get_theme_mod('hobi_blog_btn','Read More'); 
                $hobi_blog_btn_icon     = get_theme_mod('hobi_blog_btn_icon','fas fa-angle-double-right'); 
                $hobi_blog_btn_switch     = get_theme_mod('hobi_blog_btn_switch'); 
                $hobi_blog_btn_icon_switch     = get_theme_mod('hobi_blog_btn_icon_switch'); 
            ?>
            <?php if( $hobi_blog_btn_switch ): ?>
            <div class="blog-d-btn">
                <a class="btn" href="<?php the_permalink(); ?>"> <?php print esc_html($hobi_blog_btn); ?></a>
            </div>
            <?php endif; ?>
        </div>
    </div>
