...
<div class="blog-area pt-115 pb-90 gray-bg">
    <div class="container">
        <div class="row">
			<div class="col-lg-<?php print esc_attr($blog_column); ?> blog-post-items">
				<div class="blog-wrapper blog-details-text blog-details-wrapper">
					...
					while ( have_posts() ) :
						...
						<?php if( get_next_post_link() AND get_next_post_link() ) : ?>
								...
								<?php if(get_next_post_link()) : ?>
									<div class="col-xl-6 col-lg-6 col-md-6">
										<div class="project-details-content mb-15">
											<span><?php print esc_html__( 'Prev Post', 'hobi' ); ?></span>
									...
									<div class="col-xl-6 col-lg-6 col-md-6">
										<div class="project-details-content text-md-right mb-15">
											<span><?php print esc_html__( 'Next Post', 'hobi' ); ?></span>
